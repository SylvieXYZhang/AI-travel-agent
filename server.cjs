...
function safeError(error) {
  const safeCodes = new Set(['INVALID_REQUEST', 'INVALID_MESSAGE', 'MESSAGE_TOO_LONG', 'INVALID_CONVERSATION', 'BODY_TOO_LARGE', 'INVALID_JSON', 'INVALID_LLM_CONFIG', 'INVALID_MODEL_CONFIG', 'INVALID_PLAN_UPDATE', 'LLM_NOT_CONFIGURED', 'LLM_TIMEOUT', 'LLM_TEST_TIMEOUT', 'LLM_NETWORK_ERROR']);
  return {
